...
const notLoggedIn = [
  ...
  { id: 4, text: "Seja Alune", icon: "fas fa-user-graduate", to: "/aluno", onClick: () => {window.scrollTo({
    top: 0,
    left: 0,
    behavior: 'smooth'
  });} },
  { id: 5, text: "Seja Voluntárie", icon: "fas fa-hands-helping", to: "/volunteer", onClick: () => {window.scrollTo({
    top: 0,
    left: 0,
    behavior: 'smooth'
  }); } },
